        ...
        <div class="champ-participant">
            <div class="participant">
                <div class="participant-avatar">
                    <picture>
                        <source srcset="<?= $player->getAvatar($tournament->id) ?>" type="<?= IMG_ROOT ?>/webp"/>
                        <source srcset="<?= $player->getAvatar($tournament->id) ?>"/>
                        <img src="<?= $player->getAvatar($tournament->id) ?>" alt=""/>
                    </picture>
                </div>
                <div class="participant-content">
                    <div class="participant-title h5"><?= Html::encode($player->nick) ?></div>
                    <div class="participant-prop"><?= Html::encode($player->getClassName($tournament->id)) ?></div>
                </div>
            </div>
        </div>
