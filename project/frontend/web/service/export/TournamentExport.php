...
//				 }
	...
	private function loadFinalRounds(): void
	{
		foreach ($this->brackets as &$bracket)
		{
			...
			$bracket['brackets'] = [
				$this->getFinalMainBrackets($bracket['id']),
				$this->getFinalDefeatBrackets($bracket['id']),
				$this->getFinalGrandBrackets($bracket['id']),
			];
			
			$bracket['brackets'] = array_filter($bracket['brackets']);
		}
	}
