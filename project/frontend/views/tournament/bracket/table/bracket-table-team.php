...
<?= $this->render('_bracket-table-team_layout', ['dataProvider' => $dataProvider, 'isAdmin' => $isAdmin]) ?>
...
$list = ListView::widget([
    ...
    'emptyText' => $this->render('_empty_rows_guest_teams', ['tableHeaders' => $tableHeaders]), //$this->blocks['searchResultIsEmpty'],
    'dataProvider' => $dataProvider,
    'itemView' => '_bracket-table-team_row',
    'itemOptions' => [
        'tag' => false
    ],
    'viewParams' => [
...
<?php Pjax::begin([
    'id' => 'bracket-table-team',
    'timeout' => 5000,
]) ?>
    <?= $this->render('_bracket-table-team_filter', [
        'model' => $model,
        'searchModel' => $searchModel,
        'isAdmin' => $isAdmin,
    ]) ?>
