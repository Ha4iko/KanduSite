...
<div class="popup" id="adminBracketsInsertParticipants1">
    <div class="popup-wrap">
        <div class="popup-main">
            <?php Pjax::begin([
                'id' => 'bracketGroupParticipantsForm',
                'enablePushState' => false,
                'enableReplaceState' => false,
            ]); ?>
            <?= Html::beginForm(['/bracket-group/update-participants', 'id' => $model->tournament->id, 'bracketId' => $model->bracketId], 'post', [
                'data-pjax' => 1,
            ...
            <div class="popup-content">
                                ...
                                <div class="control-field">
                                    <div class="control-info">
                                        <div class="control-info__value">
                                            <span data-max="<?= $model->bracket->participants * $model->bracket->group_count ?>"
                                                  data-attached="0"
                                                  class="js-attached-count <?= (false) ? 'error' : '' ?>">0</span> of <?= $model->bracket->participants * $model->bracket->group_count ?>
                                        </div>
                ...
                <?php if (!$model->bracket->tournament->type->team_mode) : ?>
                <div class="content-block">
                    <div class="controls">
                        ...
                        <div class="control control--top">
                            ...
                            <div class="control-content">
                                <div class="checkbox checkbox--toggler">
                                    <label class="checkbox-label" for="insertParticipantsByClass">
                                        <input class="checkbox-input" type="checkbox" id="insertParticipantsByClass"
                                               name="<?= $model->formName() . '[distributeByClass]' ?>"
                                            <?= $model->distributeByClass ? 'checked="checked"' : '' ?>>
