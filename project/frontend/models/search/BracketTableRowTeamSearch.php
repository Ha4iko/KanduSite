 ...
 */
class BracketTableRowTeamSearch extends Model
{
    /**
     * @var string
     */
    ...
    public function search($params, $formName = null)
    {
        ...
        if (trim($this->name)) {
            $conditions[] = 'tm.name like "%' . trim(Html::encode($this->name)) . '%"';
        }

        $tableRows = $this->bracketService->getBracketTableRowsTeam($this->bracketId, $conditions);
