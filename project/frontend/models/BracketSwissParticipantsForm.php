 ...
 * @property SwissBracket $bracket
 */
class BracketSwissParticipantsForm extends Model
{
    /**
     * @var int
     */
    ...
    public function init()
    {
        ...
        if ($this->bracketId) {
            $this->bracket = SwissBracket::findOne([
                'id' => $this->bracketId,
                'bracket_type' => Bracket::TYPE_SWISS,
            ]);
    ...
    public function saveForm()
    {
        ...
        try {
            $this->swissService->attachParticipantsToBracket(
                $this->bracket->id,
